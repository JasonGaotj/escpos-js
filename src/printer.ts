...
export type BarcodeFontType = "A" | "B";
export type BarcodePositionType = "OFF" | "ABV" | "BLW" | "BTH";
export type BarcodeType = "EAN13" | "EAN8" | "CODE128" | "CODE93";
...
class Printer {
  ...
  public model: (model: any) => Printer;
  public marginBottom: (size: number) => Printer;
  public marginLeft: (size: number) => Printer;
  public marginRight: (size: number) => Printer;
  public print: (content: string) => Printer;
  public println: (content: string) => Printer;
  public text: (content: string, encoding?: string) => Printer;
  public info: (content: string, encoding?: string) => Printer;
  public pureText: (content: string, encoding?: string) => Printer;
  public encode: (encoding: string) => Printer;
  public feed: (n: number) => Printer;
  public control: (ctrl: ControlType) => Printer;
  public align: (align: "lt" | "ct" | "rt") => Printer;
  public font: (font: FontType) => Printer;
  public style: (align?: StyleType) => Printer;
  public size: (width: number, height: number) => Printer;
  public spacing: (n?: null | number) => Printer;
  public lineSpace: (n?: null | number) => Printer;
  public hardware: (hw: "A" | "B" | "C") => Printer;

  public cashdraw: (pin?: 2 | 5) => Printer;
  ...
  constructor(adapter: any, options?: PrinterOptions) {
    ...
    this.buffer = new MutableBuffer(DEFAULT_INITIAL_SIZE, DEFAULT_BLOCK_SIZE);
 ...
 * @return {[Printer]} printer  [the escpos printer instance]
 */
Printer.prototype.qrcode = function(code, version, level: string, size) {
  if (this._model !== "qsprinter") {
